...
@NgModule({
  declarations: [AppComponent,ChronometerPage, AddtrainingPage,AddExercisePage/*,LoginPage,SignupPage*/],
  entryComponents: [ChronometerPage,AddtrainingPage,AddExercisePage/*,LoginPage,SignupPage*/],
